...
func end_puzzle():
	...
	TextManager.show_once("Hierophant_completed", [
		"The Hierophant. Wisdom, structure, and the weight of the old ways. It turns out that even when the world turns inside out there are still rules you can’t bypass."
	])
	cooking_static_body_3d.remove_from_group("Interactables")
